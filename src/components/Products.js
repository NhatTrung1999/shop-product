            ...
            <>
                <div className="col-md-3 my-3">
                    <div className="position-sticky" style={{ top: "100px" }}>
                        ...
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("Whisky")}
                        >
                            Whisky
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("Vang")}
                        >
                            Vang
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("Sake")}
                        >
                            Sake
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("Champagne")}
                        >
                            Champagne
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("IQOS")}
                        >
                            IQOS
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("ESS")}
                        >
                            ESS
                        </button>
                        <button
                            className="btn btn-outline-dark m-1 btn-sm"
                            onClick={() => filterProduct("FUCOIDAN")}
                        >
                            FUCOIDAN
                        </button>
                    </div>
